...
// Top ~860 curated paintings from art history (Wikimedia Commons).
// Generated by: node scripts/build-art-references.js
// Uses Special:FilePath redirect URLs (resolved at download time via curl -L).
// `download-references.sh` will fetch these when TARGET=paintingwide.
const referenceUrls = require("../data/art-references-minimal.json");
